 ...
 * Classic sliding puzzle with 15 numbered tiles
 * 
 * Game Mechanics:
 * - 4x4 grid with 15 numbered tiles and one empty space
 * - Click adjacent tiles to slide them into empty space
 * - Arrange tiles in order 1-15 with empty in bottom-right
...
function initSlidingTile15Puzzle() {
...
function initLevel5() { initSlidingTile15Puzzle(); }
