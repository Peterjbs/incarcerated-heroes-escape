 ...
 * Advanced code-breaking puzzle with time pressure
 * 
 * Game Mechanics:
 * - Random 6-digit code generated each game
 * - 180-second timer countdown
 * - 12 attempts to crack the code
 * - Enhanced feedback showing correct vs wrong positions
...
function initCodeBreaker6DigitTimed() {
...
function initLevel4() { initCodeBreaker6DigitTimed(); }
